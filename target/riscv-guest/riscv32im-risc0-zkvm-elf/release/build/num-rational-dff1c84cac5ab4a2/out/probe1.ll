; ModuleID = 'probe1.dfd95821-cgu.0'
source_filename = "probe1.dfd95821-cgu.0"
...
@alloc_4a3b578d6aebcc35d274c2853cf0b1b4 = private unnamed_addr constant <{ [68 x i8] }> <{ [68 x i8] c"/opt/actions-runner/_work/rust/rust/rust/library/core/src/fmt/mod.rs" }>, align 1
@alloc_9c5b7c50d6c3d94f11341671659fc99e = private unnamed_addr constant <{ ptr, [12 x i8] }> <{ ptr @alloc_4a3b578d6aebcc35d274c2853cf0b1b4, [12 x i8] c"D\00\00\00\9E\01\00\00\0D\00\00\00" }>, align 4
@alloc_830ed40bf5af4da66ccb0a16569126d4 = private unnamed_addr constant <{ ptr, [12 x i8] }> <{ ptr @alloc_4a3b578d6aebcc35d274c2853cf0b1b4, [12 x i8] c"D\00\00\00\91\01\00\00\0D\00\00\00" }>, align 4
@alloc_44e9b0636db7209f6763db80442c0e10 = private unnamed_addr constant <{ [73 x i8] }> <{ [73 x i8] c"/opt/actions-runner/_work/rust/rust/rust/library/core/src/alloc/layout.rs" }>, align 1
@alloc_972e49db2688ae4ad8bd5e81b1caef73 = private unnamed_addr constant <{ ptr, [12 x i8] }> <{ ptr @alloc_44e9b0636db7209f6763db80442c0e10, [12 x i8] c"I\00\00\00\C4\01\00\00)\00\00\00" }>, align 4
...
define dso_local { ptr, ptr } @_ZN4core3fmt10ArgumentV113new_lower_exp17h26e96e8cd014f9aeE(ptr align 4 %x) unnamed_addr #0 {
start:
  %0 = alloca { ptr, ptr }, align 4
  store ptr %x, ptr %0, align 4
  %1 = getelementptr inbounds { ptr, ptr }, ptr %0, i32 0, i32 1
  store ptr @"_ZN4core3fmt3num3imp55_$LT$impl$u20$core..fmt..LowerExp$u20$for$u20$isize$GT$3fmt17h668f31b7834545d4E", ptr %1, align 4
...
; Function Attrs: inlinehint nounwind
define internal { ptr, i32 } @_ZN4core3fmt9Arguments6as_str17h583299f2d049cdeaE(ptr align 4 %self) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nounwind
define internal void @_ZN4core3fmt9Arguments6new_v117h2c73b7cbb61e1bbdE(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 4 %pieces.0, i32 %pieces.1, ptr align 4 %args.0, i32 %args.1) unnamed_addr #0 {
start:
...
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h7bfd5b87236baf75E(ptr sret(%"core::fmt::Arguments<'_>") %_12, ptr align 4 @alloc_e90401c92a6af8b32765b1534130c461, i32 1) #11
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h8e0197a745cba8f2E(ptr %_12, ptr align 4 @alloc_9c5b7c50d6c3d94f11341671659fc99e) #12
  unreachable
}

; core::fmt::Arguments::new_const
; Function Attrs: inlinehint nounwind
define internal void @_ZN4core3fmt9Arguments9new_const17h7bfd5b87236baf75E(ptr sret(%"core::fmt::Arguments<'_>") %0, ptr align 4 %pieces.0, i32 %pieces.1) unnamed_addr #0 {
start:
...
bb1:                                              ; preds = %start
; call core::fmt::Arguments::new_const
  call void @_ZN4core3fmt9Arguments9new_const17h7bfd5b87236baf75E(ptr sret(%"core::fmt::Arguments<'_>") %_5, ptr align 4 @alloc_e90401c92a6af8b32765b1534130c461, i32 1) #11
; call core::panicking::panic_fmt
  call void @_ZN4core9panicking9panic_fmt17h8e0197a745cba8f2E(ptr %_5, ptr align 4 @alloc_830ed40bf5af4da66ccb0a16569126d4) #12
  unreachable
}

; core::ops::function::FnOnce::call_once
; Function Attrs: inlinehint nounwind
define internal void @_ZN4core3ops8function6FnOnce9call_once17h9e18e546d1fe7645E(ptr sret(%"alloc::string::String") %0, ptr align 1 %1, i32 %2) unnamed_addr #0 {
start:
...
; call alloc::str::<impl alloc::borrow::ToOwned for str>::to_owned
  call void @"_ZN5alloc3str56_$LT$impl$u20$alloc..borrow..ToOwned$u20$for$u20$str$GT$8to_owned17hf1913849bdf5857cE"(ptr sret(%"alloc::string::String") %0, ptr align 1 %6, i32 %8) #11
  ret void
}

; core::ptr::drop_in_place<alloc::string::String>
; Function Attrs: nounwind
define dso_local void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h625a52963af42efdE"(ptr %_1) unnamed_addr #1 {
start:
; call core::ptr::drop_in_place<alloc::vec::Vec<u8>>
  call void @"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h116b464c63c0a86eE"(ptr %_1) #11
  ret void
}

; core::ptr::drop_in_place<alloc::vec::Vec<u8>>
; Function Attrs: nounwind
define dso_local void @"_ZN4core3ptr46drop_in_place$LT$alloc..vec..Vec$LT$u8$GT$$GT$17h116b464c63c0a86eE"(ptr %_1) unnamed_addr #1 {
start:
; call <alloc::vec::Vec<T,A> as core::ops::drop::Drop>::drop
  call void @"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hebec7a134fb9676eE"(ptr align 4 %_1) #11
; call core::ptr::drop_in_place<alloc::raw_vec::RawVec<u8>>
  call void @"_ZN4core3ptr53drop_in_place$LT$alloc..raw_vec..RawVec$LT$u8$GT$$GT$17h281df7b5f2a677f4E"(ptr %_1) #11
  ret void
}

; core::ptr::drop_in_place<alloc::raw_vec::RawVec<u8>>
; Function Attrs: nounwind
define dso_local void @"_ZN4core3ptr53drop_in_place$LT$alloc..raw_vec..RawVec$LT$u8$GT$$GT$17h281df7b5f2a677f4E"(ptr %_1) unnamed_addr #1 {
start:
; call <alloc::raw_vec::RawVec<T,A> as core::ops::drop::Drop>::drop
  call void @"_ZN77_$LT$alloc..raw_vec..RawVec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h44a00f0bbee757b9E"(ptr align 4 %_1) #11
  ret void
}

; core::alloc::layout::Layout::array::inner
; Function Attrs: inlinehint nounwind
define internal { i32, i32 } @_ZN4core5alloc6layout6Layout5array5inner17h399ed309f74be416E(i32 %element_size, i32 %align, i32 %n) unnamed_addr #0 {
start:
...
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h9700954fa59d8520E(ptr align 1 @str.0, i32 25, ptr align 4 @alloc_972e49db2688ae4ad8bd5e81b1caef73) #12
  unreachable
...
; Function Attrs: inlinehint nounwind
define dso_local void @"_ZN4core6option15Option$LT$T$GT$11map_or_else17h9d4f8b6f560182afE"(ptr sret(%"alloc::string::String") %0, ptr align 1 %1, i32 %2, ptr align 4 %default) unnamed_addr #0 {
start:
...
; call alloc::fmt::format::{{closure}}
  call void @"_ZN5alloc3fmt6format28_$u7b$$u7b$closure$u7d$$u7d$17h36f29bae048ef6a6E"(ptr sret(%"alloc::string::String") %0, ptr align 4 %default) #11
  br label %bb9
...
; call core::ops::function::FnOnce::call_once
  call void @_ZN4core3ops8function6FnOnce9call_once17h9e18e546d1fe7645E(ptr sret(%"alloc::string::String") %0, ptr align 1 %14, i32 %16) #11
  br label %bb9
...
; Function Attrs: inlinehint nounwind
define dso_local void @"_ZN52_$LT$T$u20$as$u20$alloc..slice..hack..ConvertVec$GT$6to_vec17h64a11b3554648b45E"(ptr sret(%"alloc::vec::Vec<u8>") %self, ptr align 1 %s.0, i32 %s.1) unnamed_addr #0 {
start:
; call alloc::raw_vec::RawVec<T,A>::allocate_in
  %0 = call { i32, ptr } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$11allocate_in17h2a63c921beb1db9fE"(i32 %s.1, i1 zeroext false) #11
...
; alloc::fmt::format
; Function Attrs: inlinehint nounwind
define internal void @_ZN5alloc3fmt6format17h02376ed3be93f394E(ptr sret(%"alloc::string::String") %0, ptr %args) unnamed_addr #0 {
start:
  %_4 = alloca ptr, align 4
; call core::fmt::Arguments::as_str
  %1 = call { ptr, i32 } @_ZN4core3fmt9Arguments6as_str17h583299f2d049cdeaE(ptr align 4 %args) #11
...
; call core::option::Option<T>::map_or_else
  call void @"_ZN4core6option15Option$LT$T$GT$11map_or_else17h9d4f8b6f560182afE"(ptr sret(%"alloc::string::String") %0, ptr align 1 %_2.0, i32 %_2.1, ptr align 4 %2) #11
  ret void
}

; alloc::fmt::format::{{closure}}
; Function Attrs: inlinehint nounwind
define dso_local void @"_ZN5alloc3fmt6format28_$u7b$$u7b$closure$u7d$$u7d$17h36f29bae048ef6a6E"(ptr sret(%"alloc::string::String") %0, ptr align 4 %1) unnamed_addr #0 {
start:
...
; call alloc::fmt::format::format_inner
  call void @_ZN5alloc3fmt6format12format_inner17h63d7bd69f93049b1E(ptr sret(%"alloc::string::String") %0, ptr %_2) #11
  ret void
}

; alloc::str::<impl alloc::borrow::ToOwned for str>::to_owned
; Function Attrs: inlinehint nounwind
define internal void @"_ZN5alloc3str56_$LT$impl$u20$alloc..borrow..ToOwned$u20$for$u20$str$GT$8to_owned17hf1913849bdf5857cE"(ptr sret(%"alloc::string::String") %0, ptr align 1 %self.0, i32 %self.1) unnamed_addr #0 {
start:
  %bytes = alloca %"alloc::vec::Vec<u8>", align 4
; call alloc::slice::<impl alloc::borrow::ToOwned for [T]>::to_owned
  call void @"_ZN5alloc5slice64_$LT$impl$u20$alloc..borrow..ToOwned$u20$for$u20$$u5b$T$u5d$$GT$8to_owned17h77725a208edd5b34E"(ptr sret(%"alloc::vec::Vec<u8>") %bytes, ptr align 1 %self.0, i32 %self.1) #11
...
; Function Attrs: inlinehint nounwind
define internal { ptr, i32 } @_ZN5alloc5alloc6Global10alloc_impl17h27f5317e11f7e60cE(ptr align 1 %self, i32 %0, i32 %1, i1 zeroext %zeroed) unnamed_addr #0 {
start:
...
; Function Attrs: nounwind
define dso_local void @"_ZN5alloc5slice64_$LT$impl$u20$alloc..borrow..ToOwned$u20$for$u20$$u5b$T$u5d$$GT$8to_owned17h77725a208edd5b34E"(ptr sret(%"alloc::vec::Vec<u8>") %0, ptr align 1 %self.0, i32 %self.1) unnamed_addr #1 {
start:
; call <T as alloc::slice::hack::ConvertVec>::to_vec
  call void @"_ZN52_$LT$T$u20$as$u20$alloc..slice..hack..ConvertVec$GT$6to_vec17h64a11b3554648b45E"(ptr sret(%"alloc::vec::Vec<u8>") %0, ptr align 1 %self.0, i32 %self.1) #11
  ret void
}

; alloc::raw_vec::RawVec<T,A>::allocate_in
; Function Attrs: nounwind
define dso_local { i32, ptr } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$11allocate_in17h2a63c921beb1db9fE"(i32 %capacity, i1 zeroext %0) unnamed_addr #1 {
start:
...
; call core::alloc::layout::Layout::array::inner
  %6 = call { i32, i32 } @_ZN4core5alloc6layout6Layout5array5inner17h399ed309f74be416E(i32 1, i32 1, i32 %capacity) #11
...
; call alloc::raw_vec::RawVec<T,A>::new_in
  %11 = call { i32, ptr } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6new_in17hdf51d92335c3de02E"() #11
...
; call alloc::raw_vec::capacity_overflow
  call void @_ZN5alloc7raw_vec17capacity_overflow17h72ca41904831f033E() #12
  unreachable
...
; call <alloc::alloc::Global as core::alloc::Allocator>::allocate
  %43 = call { ptr, i32 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$8allocate17hd23de2bda10848a4E"(ptr align 1 %alloc, i32 %layout.0, i32 %layout.1) #11
  store { ptr, i32 } %43, ptr %result, align 4
  br label %bb16

bb12:                                             ; preds = %bb11
; call <alloc::alloc::Global as core::alloc::Allocator>::allocate_zeroed
  %44 = call { ptr, i32 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$15allocate_zeroed17h6c6b9fcc92355720E"(ptr align 1 %alloc, i32 %layout.0, i32 %layout.1) #11
...
; call alloc::alloc::handle_alloc_error
  call void @_ZN5alloc5alloc18handle_alloc_error17h478d53665e8182f9E(i32 %layout.0, i32 %layout.1) #12
  unreachable
...
; Function Attrs: nounwind
define dso_local void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h060ed0da7ffebb33E"(ptr sret(%"core::option::Option<(core::ptr::non_null::NonNull<u8>, core::alloc::layout::Layout)>") %0, ptr align 4 %self) unnamed_addr #1 {
start:
...
; Function Attrs: nounwind
define dso_local { i32, ptr } @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$6new_in17hdf51d92335c3de02E"() unnamed_addr #1 {
start:
  %pointer = alloca ptr, align 4
...
; Function Attrs: inlinehint nounwind
define internal void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h617b8c13056f8a0aE"(ptr align 1 %self, ptr %ptr, i32 %0, i32 %1) unnamed_addr #0 {
start:
...
; Function Attrs: inlinehint nounwind
define internal { ptr, i32 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$15allocate_zeroed17h6c6b9fcc92355720E"(ptr align 1 %self, i32 %layout.0, i32 %layout.1) unnamed_addr #0 {
start:
; call alloc::alloc::Global::alloc_impl
  %0 = call { ptr, i32 } @_ZN5alloc5alloc6Global10alloc_impl17h27f5317e11f7e60cE(ptr align 1 %self, i32 %layout.0, i32 %layout.1, i1 zeroext true) #11
...
; Function Attrs: inlinehint nounwind
define internal { ptr, i32 } @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$8allocate17hd23de2bda10848a4E"(ptr align 1 %self, i32 %layout.0, i32 %layout.1) unnamed_addr #0 {
start:
; call alloc::alloc::Global::alloc_impl
  %0 = call { ptr, i32 } @_ZN5alloc5alloc6Global10alloc_impl17h27f5317e11f7e60cE(ptr align 1 %self, i32 %layout.0, i32 %layout.1, i1 zeroext false) #11
  %1 = extractvalue { ptr, i32 } %0, 0
  %2 = extractvalue { ptr, i32 } %0, 1
  %3 = insertvalue { ptr, i32 } poison, ptr %1, 0
  %4 = insertvalue { ptr, i32 } %3, i32 %2, 1
...
; Function Attrs: nounwind
define dso_local void @"_ZN70_$LT$alloc..vec..Vec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17hebec7a134fb9676eE"(ptr align 4 %self) unnamed_addr #1 {
start:
...
; Function Attrs: nounwind
define dso_local void @"_ZN77_$LT$alloc..raw_vec..RawVec$LT$T$C$A$GT$$u20$as$u20$core..ops..drop..Drop$GT$4drop17h44a00f0bbee757b9E"(ptr align 4 %self) unnamed_addr #1 {
start:
  %_2 = alloca %"core::option::Option<(core::ptr::non_null::NonNull<u8>, core::alloc::layout::Layout)>", align 4
; call alloc::raw_vec::RawVec<T,A>::current_memory
  call void @"_ZN5alloc7raw_vec19RawVec$LT$T$C$A$GT$14current_memory17h060ed0da7ffebb33E"(ptr sret(%"core::option::Option<(core::ptr::non_null::NonNull<u8>, core::alloc::layout::Layout)>") %_2, ptr align 4 %self) #11
...
; call <alloc::alloc::Global as core::alloc::Allocator>::deallocate
  call void @"_ZN63_$LT$alloc..alloc..Global$u20$as$u20$core..alloc..Allocator$GT$10deallocate17h617b8c13056f8a0aE"(ptr align 1 %self, ptr %ptr, i32 %layout.0, i32 %layout.1) #11
  br label %bb4
...
; probe1::probe
; Function Attrs: nounwind
define dso_local void @_ZN6probe15probe17h197950db168f6cc4E() unnamed_addr #1 {
start:
...
; call core::fmt::ArgumentV1::new_lower_exp
  %0 = call { ptr, ptr } @_ZN4core3fmt10ArgumentV113new_lower_exp17h26e96e8cd014f9aeE(ptr align 4 @alloc_83ea17bf0c4f4a5a5a13d3ae7955acd0) #11
...
; call core::fmt::Arguments::new_v1
  call void @_ZN4core3fmt9Arguments6new_v117h2c73b7cbb61e1bbdE(ptr sret(%"core::fmt::Arguments<'_>") %_3, ptr align 4 @alloc_97350e8bf483c1fe1c3a218b02d80fb1, i32 1, ptr align 4 %_7, i32 1) #11
; call alloc::fmt::format
  call void @_ZN5alloc3fmt6format17h02376ed3be93f394E(ptr sret(%"alloc::string::String") %res, ptr %_3) #11
  call void @llvm.memcpy.p0.p0.i32(ptr align 4 %_1, ptr align 4 %res, i32 12, i1 false)
; call core::ptr::drop_in_place<alloc::string::String>
  call void @"_ZN4core3ptr42drop_in_place$LT$alloc..string..String$GT$17h625a52963af42efdE"(ptr %_1) #11
  ret void
}

; core::fmt::num::imp::<impl core::fmt::LowerExp for isize>::fmt
; Function Attrs: nounwind
declare dso_local zeroext i1 @"_ZN4core3fmt3num3imp55_$LT$impl$u20$core..fmt..LowerExp$u20$for$u20$isize$GT$3fmt17h668f31b7834545d4E"(ptr align 4, ptr align 4) unnamed_addr #1

; core::panicking::panic_fmt
; Function Attrs: cold noinline noreturn nounwind
declare dso_local void @_ZN4core9panicking9panic_fmt17h8e0197a745cba8f2E(ptr, ptr align 4) unnamed_addr #2
...
; Function Attrs: nounwind
declare dso_local void @_ZN5alloc3fmt6format12format_inner17h63d7bd69f93049b1E(ptr sret(%"alloc::string::String"), ptr) unnamed_addr #1
...
declare dso_local void @_ZN5alloc7raw_vec17capacity_overflow17h72ca41904831f033E() unnamed_addr #8

; alloc::alloc::handle_alloc_error
; Function Attrs: cold noreturn nounwind
declare dso_local void @_ZN5alloc5alloc18handle_alloc_error17h478d53665e8182f9E(i32, i32) unnamed_addr #9
...
attributes #6 = { nounwind allockind("alloc,zeroed,aligned") allocsize(0) "alloc-family"="__rust_alloc" "target-cpu"="generic-rv32" "target-features"="+m" }
attributes #7 = { nounwind allockind("alloc,uninitialized,aligned") allocsize(0) "alloc-family"="__rust_alloc" "target-cpu"="generic-rv32" "target-features"="+m" }
attributes #8 = { noreturn nounwind "target-cpu"="generic-rv32" "target-features"="+m" }
attributes #9 = { cold noreturn nounwind "target-cpu"="generic-rv32" "target-features"="+m" }
attributes #10 = { nounwind allockind("free") "alloc-family"="__rust_alloc" "target-cpu"="generic-rv32" "target-features"="+m" }
